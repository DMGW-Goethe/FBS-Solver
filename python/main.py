...
if __name__ == "__main__":
	...
	filtered_data_arr = scc.filter_stab_curve_data(df, stab_curve)

	#print(type(df))
	#print(type(filtered_data_arr))

	pfuncts.plot_interpolate_stability_region(filtered_data_arr, 2, 20.0, 2.5, 0.55, True, plot_title, my_plot_filename)

	my_stabcurveMR = scc.stab_curve_to_MR(df, stab_curve, NstarsRho, NstarsPhi)
