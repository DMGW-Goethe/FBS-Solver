...
namespace integrator
{
    ...
    struct IntegrationOptions {
        ...
        int verbose;
        IntegrationOptions(const int max_step=1000000, const double target_error=1e-12, const double min_stepsize=1e-18, const double max_stepsize=1e-2, const bool save_intermediate=false, const int verbose=0)
